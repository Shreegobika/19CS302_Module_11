...
4.In the main() function: Accept an integer input from the user. Call findSquare(number) with the input value.
...
## Output:
<img width="422" height="201" alt="image" src="https://github.com/user-attachments/assets/fddedd81-6c9c-412d-8efb-46bb5c3db5e8" />
