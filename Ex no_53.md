...
7.Check if the element already exists in temp. If the element is not a duplicate, add it to temp and increment index. Copy the elements from temp back to the original array.
...
## Output:
<img width="455" height="251" alt="image" src="https://github.com/user-attachments/assets/0bda983b-5e7a-4409-aeaf-7c038519a88c" />
